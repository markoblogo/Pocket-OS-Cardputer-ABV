...
//----------------------------------------------------------------------------
  ...
  namespace colors  // Colour enumeration
  {
    ...
    static constexpr int TFT_BEIGE           = 0xF7BB;      /* 245, 245, 220 */
    static constexpr int TFT_BISQUE          = 0xFF38;      /* 255, 228, 196 */
    static constexpr int TFT_BLANCHEDALMOND  = 0xFF59;      /* 255, 235, 205 */
    static constexpr int TFT_BLUEVIOLET      = 0x895C;      /* 138,  43, 226 */
    static constexpr int TFT_BURLYWOOD       = 0xDDD0;      /* 222, 184, 135 */
    static constexpr int TFT_CADETBLUE       = 0x5CF4;      /*  95, 158, 160 */
    static constexpr int TFT_CHARTREUSE      = 0x7FE0;      /* 127, 255,   0 */
    static constexpr int TFT_CHOCOLATE       = 0xD343;      /* 210, 105,  30 */
    static constexpr int TFT_CORAL           = 0xFBEA;      /* 255, 127,  80 */
    static constexpr int TFT_CORNFLOWERBLUE  = 0x64BD;      /* 100, 149, 237 */
    static constexpr int TFT_CORNSILK        = 0xFFDB;      /* 255, 248, 220 */
    static constexpr int TFT_CRIMSON         = 0xD8A7;      /* 220,  20,  60 */
    static constexpr int TFT_DARKGOLDENROD   = 0xBC21;      /* 184, 134,  11 */
    static constexpr int TFT_DARKKHAKI       = 0xBDAD;      /* 189, 183, 107 */
    static constexpr int TFT_DARKMAGENTA     = 0x8811;      /* 139,   0, 139 */
    static constexpr int TFT_DARKOLIVEGREEN  = 0x5345;      /*  85, 107,  47 */
    static constexpr int TFT_DARKORANGE      = 0xFC60;      /* 255, 140,   0 */
    static constexpr int TFT_DARKORCHID      = 0x9999;      /* 153,  50, 204 */
    static constexpr int TFT_DARKRED         = 0x8800;      /* 139,   0,   0 */
    static constexpr int TFT_DARKSALMON      = 0xECAF;      /* 233, 150, 122 */
    static constexpr int TFT_DARKSEAGREEN    = 0x8DF1;      /* 143, 188, 143 */
    static constexpr int TFT_DARKSLATEBLUE   = 0x49F1;      /*  72,  61, 139 */
    static constexpr int TFT_DARKSLATEGRAY   = 0x2A69;      /*  47,  79,  79 */
    static constexpr int TFT_DARKTURQUOISE   = 0x067A;      /*   0, 206, 209 */
    static constexpr int TFT_DARKVIOLET      = 0x901A;      /* 148,   0, 211 */
    static constexpr int TFT_DEEPPINK        = 0xF8B2;      /* 255,  20, 147 */
    static constexpr int TFT_DEEPSKYBLUE     = 0x05FF;      /*   0, 191, 255 */
    static constexpr int TFT_DIMGRAY         = 0x6B4D;      /* 105, 105, 105 */
    static constexpr int TFT_DODGERBLUE      = 0x1C9F;      /*  30, 144, 255 */
    static constexpr int TFT_FIREBRICK       = 0xB104;      /* 178,  34,  34 */
    static constexpr int TFT_FLORALWHITE     = 0xFFDE;      /* 255, 250, 240 */
    static constexpr int TFT_FORESTGREEN     = 0x2444;      /*  34, 139,  34 */
    static constexpr int TFT_GAINSBORO       = 0xDEFB;      /* 220, 220, 220 */
    static constexpr int TFT_GHOSTWHITE      = 0xFFDF;      /* 248, 248, 255 */
    static constexpr int TFT_GOLDENROD       = 0xDD24;      /* 218, 165,  32 */
    static constexpr int TFT_HONEYDEW        = 0xF7FE;      /* 240, 255, 240 */
    static constexpr int TFT_HOTPINK         = 0xFB56;      /* 255, 105, 180 */
    static constexpr int TFT_INDIANRED       = 0xCAEB;      /* 205,  92,  92 */
    static constexpr int TFT_INDIGO          = 0x4810;      /*  75,   0, 132 */
    static constexpr int TFT_IVORY           = 0xFFFE;      /* 255, 255, 240 */
    static constexpr int TFT_KHAKI           = 0xF731;      /* 240, 230, 140 */
    static constexpr int TFT_LAVENDER        = 0xE73F;      /* 230, 230, 250 */
    static constexpr int TFT_LAVENDERBLUSH   = 0xFF9E;      /* 255, 240, 245 */
    static constexpr int TFT_LAWNGREEN       = 0x7FE0;      /* 124, 252,   0 */
    static constexpr int TFT_LEMONCHIFFON    = 0xFFD9;      /* 255, 250, 205 */
    static constexpr int TFT_LIGHTBLUE       = 0xAEDC;      /* 173, 216, 230 */
    static constexpr int TFT_LIGHTCORAL      = 0xF410;      /* 240, 128, 128 */
    static constexpr int TFT_LIGHTCYAN       = 0xE7FF;      /* 224, 255, 255 */
    static constexpr int TFT_LIGHTGOLDENRODYELLOW = 0xFFDA; /* 250, 250, 210 */
    static constexpr int TFT_LIGHTGREEN      = 0x9772;      /* 144, 238, 144 */
    static constexpr int TFT_LIGHTPINK       = 0xFDB8;      /* 255, 182, 193 */
    static constexpr int TFT_LIGHTSALMON     = 0xFD0F;      /* 255, 160, 122 */
    static constexpr int TFT_LIGHTSEAGREEN   = 0x2595;      /*  32, 178, 170 */
    static constexpr int TFT_LIGHTSKYBLUE    = 0x867F;      /* 135, 206, 250 */
    static constexpr int TFT_LIGHTSLATEGRAY  = 0x7453;      /* 119, 136, 153 */
    static constexpr int TFT_LIGHTSTEELBLUE  = 0xB63B;      /* 176, 196, 222 */
    static constexpr int TFT_LIGHTYELLOW     = 0xFFFC;      /* 255, 255, 224 */
    static constexpr int TFT_LIMEGREEN       = 0x3666;      /*  50, 205,  50 */
    static constexpr int TFT_LINEN           = 0xFF9C;      /* 250, 240, 230 */
    static constexpr int TFT_MEDIUMAQUAMARINE = 0x6675;     /* 102, 205, 170 */
    static constexpr int TFT_MEDIUMBLUE      = 0x0019;      /*   0,   0, 205 */
    static constexpr int TFT_MEDIUMORCHID    = 0xBABA;      /* 186,  85, 213 */
    static constexpr int TFT_MEDIUMPURPLE    = 0x939B;      /* 147, 112, 219 */
    static constexpr int TFT_MEDIUMSEAGREEN  = 0x3D8E;      /*  60, 179, 113 */
    static constexpr int TFT_MEDIUMSLATEBLUE = 0x7B5D;      /* 123, 104, 238 */
    static constexpr int TFT_MEDIUMSPRINGGREEN = 0x07D3;   /*   0, 250, 154 */
    static constexpr int TFT_MEDIUMTURQUOISE = 0x4E99;      /*  72, 209, 204 */
    static constexpr int TFT_MEDIUMVIOLETRED = 0xC0B0;      /* 199,  21, 133 */
    static constexpr int TFT_MIDNIGHTBLUE    = 0x18CE;      /*  25,  25, 112 */
    static constexpr int TFT_MINTCREAM       = 0xF7FF;      /* 245, 255, 250 */
    static constexpr int TFT_MISTYROSE       = 0xFF3C;      /* 255, 228, 225 */
    static constexpr int TFT_MOCCASIN        = 0xFF36;      /* 255, 228, 181 */
    static constexpr int TFT_NAVAJOWHITE     = 0xFEF5;      /* 255, 222, 173 */
    static constexpr int TFT_OLDLACE         = 0xFFBC;      /* 253, 245, 230 */
    static constexpr int TFT_OLIVEDRAB       = 0x6C64;      /* 107, 142,  35 */
    static constexpr int TFT_ORANGERED       = 0xFA20;      /* 255,  69,   0 */
    static constexpr int TFT_ORCHID          = 0xDB9A;      /* 218, 112, 214 */
    static constexpr int TFT_PALEGOLDENROD   = 0xEF55;      /* 238, 232, 170 */
    static constexpr int TFT_PALEGREEN       = 0x9FD3;      /* 152, 251, 152 */
    static constexpr int TFT_PALETURQUOISE   = 0xAF7D;      /* 175, 238, 238 */
    static constexpr int TFT_PALEVIOLETRED   = 0xDB92;      /* 219, 112, 147 */
    static constexpr int TFT_PAPAYAWHIP      = 0xFF7A;      /* 255, 239, 213 */
    static constexpr int TFT_PEACHPUFF       = 0xFED7;      /* 255, 218, 185 */
    static constexpr int TFT_PERU            = 0xCC27;      /* 205, 133,  63 */
    static constexpr int TFT_PLUM            = 0xDD1B;      /* 221, 160, 221 */
    static constexpr int TFT_POWDERBLUE      = 0xB71C;      /* 176, 224, 230 */
    static constexpr int TFT_REBECCAPURPLE   = 0x6193;      /* 102,  51, 153 */
    static constexpr int TFT_ROSYBROWN       = 0xBC71;      /* 188, 143, 143 */
    static constexpr int TFT_ROYALBLUE       = 0x435C;      /*  65, 105, 225 */
    static constexpr int TFT_SADDLEBROWN     = 0x8A22;      /* 139,  69,  19 */
    static constexpr int TFT_SALMON          = 0xFC0E;      /* 250, 128, 114 */
    static constexpr int TFT_SANDYBROWN      = 0xF52C;      /* 244, 164,  96 */
    static constexpr int TFT_SEAGREEN        = 0x2C4A;      /*  46, 139,  87 */
    static constexpr int TFT_SEASHELL        = 0xFFBD;      /* 255, 245, 238 */
    static constexpr int TFT_SIENNA          = 0xA285;      /* 160,  82,  45 */
    static constexpr int TFT_SLATEBLUE       = 0x6AD9;      /* 106,  90, 205 */
    static constexpr int TFT_SLATEGRAY       = 0x7412;      /* 112, 128, 144 */
    static constexpr int TFT_SLATEGREY       = 0x7412;      /* 112, 128, 144 */
    static constexpr int TFT_GRAY            = 0x8410;      /* 128, 128, 128 */
    static constexpr int TFT_GREY            = 0x8410;      /* 128, 128, 128 */
    static constexpr int TFT_SNOW            = 0xFFDF;      /* 255, 250, 250 */
    static constexpr int TFT_SPRINGGREEN     = 0x07EF;      /*   0, 255, 127 */
    static constexpr int TFT_STEELBLUE       = 0x4416;      /*  70, 130, 180 */
    static constexpr int TFT_TAN             = 0xD5B1;      /* 210, 180, 140 */
    static constexpr int TFT_THISTLE         = 0xDDFB;      /* 216, 191, 216 */
    static constexpr int TFT_TOMATO          = 0xFB08;      /* 255,  99,  71 */
    static constexpr int TFT_TURQUOISE       = 0x471A;      /*  64, 224, 208 */
    static constexpr int TFT_WHEAT           = 0xF6F6;      /* 245, 222, 179 */
    static constexpr int TFT_WHITESMOKE      = 0xF7BE;      /* 245, 245, 245 */
    static constexpr int TFT_YELLOWGREEN     = 0x9E66;      /* 154, 205,  50 */
  }
